// week13_3.cpp 學習計畫 Linked List 第3題
// LeetCode 2. Add Two Numbers 把鏈結串列 Linked List 裡面的數 逐項相加 小心進位carry
class Solution {
public:
    ListNode* addTwoNumbers(ListNode* l1, ListNode* l2) {
        ListNode* ans = new ListNode(999); // 故意放999 代表奇怪的值
        ListNode* ans2 = ans; // 會滑動的指標 把ans 後面的 Linked List 逐一處理好
        ...
        while(l1 != nullptr || l2 != nullptr){ // 只要有1個不是空指標
            ...
            ans2->next = new ListNode(now % 10); // 慢慢接好 後面的答案
